...
// Example in fsend_otp.php
error_log("Send OTP request received.");
...
function smtp_mailer($to,$subject, $msg){
	...
	$mail->IsHTML(true);
	$mail->CharSet = 'UTF-8';
	$mail->Username = "gptyash253@gmail.com";   
    $mail->Password = "jtqf jfby stls xecn"; 	
    $mail->SetFrom("gptyash253@gmail.com");  
