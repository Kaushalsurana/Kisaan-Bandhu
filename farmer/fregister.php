...
<footer class="footer">
        <div class="container">
                ...
                <div class="offset-sm-2 col-5 ">
                    ...
                    <a role="button" class="btn btn-primary" href="tel:+919350407133"><i class="fa fa-phone"></i> Call</a>
                    <a role="button" class="btn btn-info" href="tel:+919350407133"> <i class="fa fa-fax"></i> Fax</a>
                    <a role="button" class="btn btn-success" href="mailto:e22cseu1117@bennett.edu.in"> <i class="fa fa-envelope-o"></i> Email</a>
                </div>
		           </address>
                </div>				
