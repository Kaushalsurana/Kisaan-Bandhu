			...
			<?php
							...
							require_once "StripePayment/config.php";
								...
								$session = \Stripe\Checkout\Session::create([
									...
									'mode' => 'payment',
									'success_url' => 'http://localhost/Lab/Project Showcase/agriculture-portal-main/customer/cupdatedb.php"',
									'cancel_url' => 'http://localhost/Lab/Project Showcase/agriculture-portal-main/customer/cbuy_crops.php',
								]);
